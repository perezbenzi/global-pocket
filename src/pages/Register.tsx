      ...
      <div className="w-full max-w-md p-8">
        <div className="rounded-xl overflow-hidden shadow-lg bg-card">
          <div className="bg-primary p-5">
            <h2 className="text-xl font-bold text-primary-foreground">Create Account</h2>
          </div>
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <p className="text-sm text-foreground text-center pt-3">
              Already have an account? <a href="/login" className="text-primary font-medium hover:text-primary/80 transition-colors">Login</a>
            </p>
          </form>
        </div>
      </div>
